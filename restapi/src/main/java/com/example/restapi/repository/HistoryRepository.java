...
public interface HistoryRepository extends JpaRepository<History, Long> {
    ...
    @Query(value = "SELECT * FROM history where ambulance_id = :ambulanceId AND code LIKE :code AND created_on > NOW() - INTERVAL 15 MINUTE", nativeQuery = true)
    Optional<History> findByAmbulanceAndTime(long ambulanceId, String code);
